                ...
                response -> {
                    try {
                        for (int i = 0; i < response.length(); i++) {
                            ...
                            person.setNombre(object.getString("nombre"));
                            person.setTelefono(object.optString("telefono", null));
                            person.setLatitud(object.optString("latitud", ""));
                            person.setLongitud(object.optString("longitud", ""));
                            person.setVideo(object.optString("video", ""));
