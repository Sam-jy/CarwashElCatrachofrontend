...
public class AdminDashboardFragment extends Fragment {
    ...
    private MaterialCardView cardPendingQuotations, cardHistory, cardUsers, cardReports;
    ...
    private void bindViews(View view) {
        ...
        cardPendingQuotations = view.findViewById(R.id.card_admin_pending_quotations);
        cardHistory = view.findViewById(R.id.card_admin_history);
        cardUsers = view.findViewById(R.id.card_admin_users);
        cardReports = view.findViewById(R.id.card_admin_reports);

        if (cardPendingQuotations != null) {
            cardPendingQuotations.setOnClickListener(v -> Navigation.findNavController(v).navigate(R.id.action_adminDashboard_to_quotations));
        }
        if (cardHistory != null) {
            cardHistory.setOnClickListener(v -> Navigation.findNavController(v).navigate(R.id.action_adminDashboard_to_history));
        }
        if (cardUsers != null) {
            cardUsers.setOnClickListener(v -> Navigation.findNavController(v).navigate(R.id.action_adminDashboard_to_users));
        }
        if (cardReports != null) {
            cardReports.setOnClickListener(v -> Navigation.findNavController(v).navigate(R.id.action_adminDashboard_to_reports));
        }
    }
